...
function AIGenerator() {
  ...
  return (
    <div style={{ marginTop: 80 }}>
      ...
      />
      <button onClick={generate} style={{ marginTop: 10, padding: "10px 20px", background: "cyan" }}>
        Generate
      </button>
...
function Creativity() {
  return (
    <div style={{ marginTop: 80, maxWidth: 900 }}>
      ...
      <ul><li>Fabrici</li><li>Materii prime</li><li>Spații fizice</li></ul>
...
function SalaryCalculator() {
  ...
  return (
    <div style={{ marginTop: 80 }}>
      ...
      <p style={{ marginTop: 20, fontSize: 24, color: "cyan" }}>{salaries[level]}</p>
    </div>
  )
}
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 20, flexWrap: "wrap" }}>
        {timeline.map((t, i) => (
          <button
            key={i}
            onClick={() => setStep(i)}
            style={{ padding: 10, background: i === step ? "cyan" : "#222", color: i === step ? "black" : "white" }}
          >
            {t.year}
          </button>
        ))}
